...
INSERT INTO `instansi_kesehatan` (`id_instansi`, `nama_instansi`, `tipe`, `alamat`, `kontak`, `created_at`) VALUES
...
INSERT INTO `pasien` (`id_pasien`, `nama`, `tanggal_lahir`, `alamat`, `info_kontak`, `id_instansi`, `id_kecamatan`, `id_penyakit`, `created_at`) VALUES
('PS00000001', 'Abdul Rojak', '1989-04-11', 'Jl. Raya Sawangan No. 3, Mampang, Pancoran Mas, Depok.', '085780827731', 'IS0001', 'KEC01', 'PK001', '2024-04-17 02:40:36'),
('PS00000002', 'Agus Anjay', '1989-04-11', 'Jl. Raya Sawangan No. 3, Mampang, Pancoran Mas, Depok.', '085780827731', 'IS0004', 'KEC03', 'PK004', '2024-04-17 02:41:34'),
('PS00000003', 'Jokowo', '1989-04-11', 'Jl. Raya Sawangan No. 3, Mampang, Pancoran Mas, Depok.', '085780827731', 'IS0003', 'KEC04', 'PK002', '2024-04-17 02:41:34');
...
CREATE TABLE `penyakit` (
  ...
  `gambar_pemyakit` varchar(255) NOT NULL,
...
INSERT INTO `penyakit` (`id_penyakit`, `nama_penyakit`, `gambar_pemyakit`, `info_gejala`, `info_pencegahan`, `info_pengobatan`, `created_at`) VALUES
...
INSERT INTO `user` (`id_user`, `nama`, `email`, `password`, `role_id`, `created_at`) VALUES
('USR001', 'Admin', 'admin@gmail.com', '$2y$10$wkBWSl.wRRG8rzRCFUp3cu7d70mF39W2H/UAKel7G6On6BJX/tITq', '2', '2024-04-17 02:37:22'),
('USR002', 'Petugas Satu', 'petugas1@gmail.com', '$2y$10$wkBWSl.wRRG8rzRCFUp3cu7d70mF39W2H/UAKel7G6On6BJX/tITq', '1', '2024-04-17 02:37:47'),
('USR003', 'Petugas Dua', 'petugas2@gmail.com', '$2y$10$wkBWSl.wRRG8rzRCFUp3cu7d70mF39W2H/UAKel7G6On6BJX/tITq', '1', '2024-04-17 02:37:47');
